...
jQuery(document).ready(function () {
  if (document.getElementById("dashboard")) {
        ...
        <div class="product" v-bind:id="'product_' + productFromApi.sku.toLowerCase()" v-bind:class="{ 'product__installed': productIs.installed, 'product__connected' : productIs.connected, 'product__activated': productIs.activated,'product__plugin' : productType == 'plugin', 'product__theme' : productType == 'theme'}">
          ...
          <div class="product__description">
            ...
            <div v-if="!wpsGoldSiteConnected" v-on:click="showConnectionInfosModal" v-bind:class="[productIs.connected ? 'text-success' : 'text-danger']" class="product__connection text-success">
              ...
              <p class="product__exerpt">{{productFromApi.exerpt}} <span class="product__learn-more">&mdash; <a v-bind:href="productFromApi.url + '?utm_source=core&utm_medium=dashboard&utm_campaign=' + productFromApi.slug + '&utm_content=learnMore'" target="_blank" v-bind:title="'View details about ' + productFromApi.title">Learn more</a></span></p>
          </div>
          ...
          <div class="product__footer">
            ...
            <template v-if="!productIs.connected">
              ...
              <template v-else>
                <a v-bind:href="productFromApi.url + '?utm_source=core&utm_medium=dashboard&utm_campaign=' + productFromApi.slug + '&utm_content=buyNow'" target="_blank" class="btn btn-sm btn-pink" v-bind:title="'Buy ' + productFromApi.title">
    ...
    var wpsVueProducts = {
      ...
      mounted: function () {
        this.filter = this.$i18n['products__filter__all'];
      },
          ...
          this.$http
            ...
            .then(
              function (response) {
                ...
                this.userLicenseInput = this.userHasLicense ? hiddenLicense : '';
