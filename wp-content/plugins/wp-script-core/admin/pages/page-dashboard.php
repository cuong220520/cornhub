							...
							<?php if ( ! in_array( 'administrator', (array) $current_blog_user->roles, true ) ) : ?>
								<div class="row">
									<div class="col-xs-12 col-md-6 col-md-push-3">
										...
										<div class="alert alert-info">
											<p class="text-center">You must be logged as an <strong>Administrator</strong> to access this page.</p>
										</div>
									</div>
								</div>
								...
								<transition name="fade">
									<div v-if="dataLoaded">
										<div class="row" v-if="fullLifetime.can_upgrade">
											<div class="col-xs-12">
												<a v-bind:href="fullLifetime.url + '?utm_source=core&utm_medium=dashboard&utm_campaign=fullLifetime&utm_content=learnMore&flpp=' + fullLifetime.price_to_pay" target="_blank" class="alert text-center p-2 mb-5" style="border: 2px solid #A950A9; display: flex; align-items: center; justify-content: center; color: #555;">
													<strong style="color: #333">FULL ACCESS <span style="color: #A950A9">LIFETIME</span></strong>
													<span class="px-2">Get All Products / Unlimited Sites for only
													...
													<span class="btn btn-sm btn-default" style="background: #932493; color: #fff; border: none !important; font-weight: bold;">Learn more</span>
												</a>
											</div>
										</div>
											...
											<div class="row">
												<div class="col-xs-12">
													<div class="alert text-center p-4" v-bind:class="[wpsGold.site_connected ? 'wps-gold wps-gold-connected' : 'alert-license']">
														...
														<?php else : ?>
															<p><?php esc_html_e( 'Your license is valid. It is hidden for security reasons.', 'wpscore_lang' ); ?></p>
														<?php endif; ?>
													</div>
												</div>
											</div>
